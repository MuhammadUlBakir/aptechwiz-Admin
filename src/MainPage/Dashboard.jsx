...
import TransTable from '../PageComponents/TransTable';
    ...
    <div className="container-fluid">
      ...
      <div className="row">
       ...
       <TransTable/>
            ...
            <h4 style={{ textAlign: "center" , fontWeight : "bold" }}>Top Selling Products</h4>
            <br />
           <ProductCardList/>
      <div className="py-6 px-6 text-center">
        <p>Design and Developed by Techwiz 2023 Team Hyderabad Sindh</p>
      </div>
    </div>
  </div>
</div>
